//Importamos el type de la guitarra que definimos en un archivo nuevo
import type { Guitar } from '../types';

//Asignamos types globales para no crearlos en forma de inline Types
type GuitarProps = {
    guitar: Guitar
...
//le damos tipado a nuestras props con el global type 'GuitarProps' que definimos arriba
